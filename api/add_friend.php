...
$user2=$_REQUEST['user_id2'];// to whom request is being sent
...
if(!($token && $user2)){
	...
	if(count($res)){
		...
		//checking current follow status- whether already friends or not
    	if(!count($fr)){
			...
			$message=array();
			$message['user_id']=$uid;
			$message['msg']= $uname. ' wants to follow you ';
